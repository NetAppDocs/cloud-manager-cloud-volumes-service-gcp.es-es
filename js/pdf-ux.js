$(document).ready(function () {
  try {
    ...
    let baseUrlSection = "/es-es/cloud-manager-cloud-volumes-service-gcp/pdfs/";
    ...
    zipFilename = zipFilename !== ''?zipFilename:"cloud-manager-cloud-volumes-service-gcp.es-es.zip";
